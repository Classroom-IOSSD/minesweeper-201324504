...
#include "conio.h"
#include <stdbool.h>
#define MAX 10 // background color
#define BRED  "\x1B[41m"
#define BGRN  "\x1B[42m"
#define BYEL  "\x1B[43m"
#define BBLU  "\x1B[44m"
#define BMAG  "\x1B[45m"
#define BCYN  "\x1B[46m"
#define BWHT  "\x1B[47m" // text color
#define KNRM  "\x1B[0m"
#define KRED  "\x1B[31m"
#define KGRN  "\x1B[32m"
#define KYEL  "\x1B[33m"
 					...
 					co_x = co_x % MAX;
 						...
 						do {
 							...
 							if (direction == '8') {
 								...
 								value = table_array[co_y][co_x];
 								if (value == 0) {
 									// blank case
 									uncover_blank_cell(co_y, co_x);
 								}
